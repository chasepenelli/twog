...
if modal is not None:
    ...
    _OMICS_MODULE = Path(__file__).resolve().parent / "ingestion_bridge" / "omics_review.py"
    image = (
    ...
    _DOCKING_MODULE = Path(__file__).resolve().parent / "ingestion_bridge" / "docking.py"
    gnina_image = (
    ...
    _COFOLDING_MODULE = Path(__file__).resolve().parent / "ingestion_bridge" / "cofolding.py"
