-- Proof Network work packets (public-site mirror).
--
-- This table is populated by the research-store work_packet_seed_job and
-- read by the public API at GET /api/public-candidates/:id/work-packets.
-- Public submissions never write here; only the hosted research pipeline
-- creates or retires packets.
