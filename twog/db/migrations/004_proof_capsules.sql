-- Proof Network proof capsules + reviews (public-site mirror).
--
-- POST /api/proof-capsules writes here; GET /api/proof-capsules/:id reads.
-- Reviews are written by the operator/reviewer path (Python or future
-- operator console); the public read path never includes review_notes or
-- operator identity.
